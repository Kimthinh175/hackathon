  ...
  return (
    <section id="alerts" className="view-section animate-up">
        <div className="page-header mb-12">
            <div>
              <h2 className="text-3xl font-black text-gray-800 tracking-tight">Cảnh báo Tồn kho & Hạn sử dụng</h2>
              <p className="text-gray-400 font-bold text-sm tracking-widest uppercase mt-1">Theo dõi các chỉ số vận hành quan trọng (Min/Max & FEFO)</p>
            </div>
            <div className="flex gap-4">
                <div className="bg-rose-50 px-6 py-3 rounded-2xl border border-rose-100 flex items-center gap-3">
                    <span className="text-xs font-black text-rose-600 uppercase tracking-widest">Phát hiện: {(alerts?.minMax?.length || 0) + (alerts?.fefo?.length || 0)} vấn đề</span>
                </div>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="card p-8 bg-white shadow-xl border border-indigo-50 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-10 border-b pb-6 border-gray-50">
                    ...
                    <div>
                        <h3 className="text-lg font-black text-gray-800 uppercase tracking-tighter">Cảnh báo Định mức (Min/Max)</h3>
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Tồn kho dưới mức an toàn hoặc vượt ngưỡng</p>
                    </div>
                </div>
                ...
                <div className="mt-auto pt-8 border-t border-gray-50">
                    <button className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black text-xs shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition">TỰ ĐỘNG LẬP PHIẾU YÊU CẦU MUA HÀNG</button>
                </div>
            </div>
            ...
            <div className="card p-8 bg-white shadow-xl border border-rose-50 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-10 border-b pb-6 border-gray-50">
                    ...
                    <div>
                        <h3 className="text-lg font-black text-gray-800 uppercase tracking-tighter">Cảnh báo Hạn sử dụng (FEFO)</h3>
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Xử lý các lô hàng cận date hoặc đã hết hạn</p>
                    </div>
                </div>
                ...
                <div className="mt-auto pt-8 border-t border-gray-50">
                    <button className="w-full bg-rose-600 text-white py-4 rounded-2xl font-black text-xs shadow-xl shadow-rose-100 hover:bg-rose-700 transition">CHIẾT XUẤT LỆNH TIÊU HỦY / XẢ KHO</button>
                </div>
            </div>
        </div>
    </section>
